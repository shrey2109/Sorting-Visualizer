...
const QuickComplexity = () => {
  ...
  return(
    <>
        <h1> Complexities for Quick Sort </h1>
    ...
    {/* <TabContext> */}
        ...
        <TabPanel value="1"> 
            <code>
                <div style={{marginLeft:'0px'}}> {`O(nlogn)`} </div>
            </code>
        </TabPanel>
        <TabPanel value="2"> 

            <code>
                <div style={{marginLeft:'0px'}}> {`O(logn)`} </div>
            </code>
...
export default QuickComplexity;